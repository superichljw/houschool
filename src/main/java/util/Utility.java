...
public class Utility {
	  // 서비스시에는 도메인으로 변경됨.
	// 지금 현재 프로젝트에서는 경로를 servlet-context.xml을 통해 따로 잡아둠
	// Utility.getRoot()는 기본 톰캣 경로를 제공(C:Program Files/Apache Software Foundation/Tomcat8.5/wtpwebapps/
	// 그리고 기본 주소 뒤에 root 에 설정해 놓은 주소가 붙음
	// 중간중간 deprecated 메소드가 있긴 한데, 그래도 잘 작동됨
	  private static final String root = "/videoclass"; //프로젝트이름
